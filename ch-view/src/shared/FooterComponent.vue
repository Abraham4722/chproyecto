        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="index.html">
                <img src="@/plantilla/images/main-logo.png" alt="logo">
              </a>
            </div>
        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-wrap">
            <div class="shipping">
              ...
              <img src="@/plantilla/images/arct-icon.png" alt="icon">
              <img src="@/plantilla/images/dhl-logo.png" alt="icon">
            </div>
            <div class="payment-option">
              <span>Payment Option:</span>
              <img src="@/plantilla/images/visa-card.png" alt="card">
              <img src="@/plantilla/images/paypal-card.png" alt="card">
              <img src="@/plantilla/images/master-card.png" alt="card">
            </div>
          </div>
